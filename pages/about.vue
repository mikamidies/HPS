    ...
    <div class="first">
      <div class="container small separator">
        ...
        <div class="right">
          ...
          <div>
            <img src="@/assets/img/about.png" class="image" alt="" />
          </div>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      title: this.$store.state.translations["about.0_key0"],
      full_name: "",
      number: "",
      email: "",
      file: "",
...
.second :deep(.anticon-paper-clip) {
  display: none;
}
.grid :deep(span) {
  position: relative;
