          ...
          <div :class="{ active: handleConfig == true }" class="config tab">
            ...
            <div class="items">
              <div class="item">
                <div class="name">
                  ...
                  <p>Исполнение <span class="dot">*</span></p>
                </div>
                <a-select :placeholder="select">
                  <a-select-option value="Intel"> Intel </a-select-option>
                  <a-select-option value="AMD"> AMD </a-select-option>
                </a-select>
                <a-select :placeholder="select">
                  <a-select-option value="Intel"> Intel </a-select-option>
                  <a-select-option value="AMD"> AMD </a-select-option>
              ...
              <div class="item">
                <div class="name">
                  ...
                  <p>Процессор <span class="dot">*</span></p>
                </div>
                <a-select :placeholder="select">
                  <a-select-option value="Intel"> Intel </a-select-option>
                  <a-select-option value="AMD"> AMD </a-select-option>
              ...
              <div class="item">
                <div class="name">
                  ...
                  <p>Оперативная память <span class="dot">*</span></p>
                </div>
                <a-select :placeholder="select">
                  <a-select-option value="Intel"> Intel </a-select-option>
                  <a-select-option value="AMD"> AMD </a-select-option>
              ...
              <div class="item">
                <div class="name">
                  ...
                  <p>Требуемые уровни RAID <span class="dot">*</span></p>
                </div>
                <a-select :placeholder="select">
                  <a-select-option value="Intel"> Intel </a-select-option>
                  <a-select-option value="AMD"> AMD </a-select-option>
              ...
              <div class="item">
                <div class="name">
                  ...
                  <p>Сетевые интерфейсы <span class="dot">*</span></p>
                </div>
                <a-select :placeholder="select">
                  <a-select-option value="Intel"> Intel </a-select-option>
                  <a-select-option value="AMD"> AMD </a-select-option>
              ...
              <div class="item">
                <div class="name">
                  ...
                  <p>Блок питания <span class="dot">*</span></p>
                </div>
                <a-select :placeholder="select">
                  <a-select-option value="Intel"> Intel </a-select-option>
                  <a-select-option value="AMD"> AMD </a-select-option>
            ...
            <div class="warn">
              ...
              <p>
                ...
                когда приедет. Потеряли трек-номер? Он есть у нашего логиста. В
                ТК перепутали заказы — логист знает что делать.
              </p>
            </div>
